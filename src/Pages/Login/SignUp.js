        ...
        <div className='flex h-screen justify-center items-center'>
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="text-center text-2xl fond-bold">Sign Up</h2>
                    ...
                    <p className='text-center'>Alredy have an account? <Link className='text-primary' to="/login">Please Login</Link></p>
